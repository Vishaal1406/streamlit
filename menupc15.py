...
from reportlab.lib.pagesizes import letter, A4,mm,portrait
...
if st.session_state.page == "Menu":
    ...
    for item, details in st.session_state.cart.items():
            ...
            final_total = subtotal + tax
    if st.button("Generate Bill 🧾"):
        st.session_state.bill_pdf = generate_bill(st.session_state.cart,tax, final_total)
        st.session_state.page = "Bill"
        st.rerun()
    if st.button(translate_text("Back to Menu")):
        st.session_state.page = "Menu"
    ...
    if st.session_state.bill_pdf:
        ...
        # Generate Image (html2image or Selenium)
        try:
        ...
        # Function to generate PDF for bill printer
        ...
        if pdf_buffer:
            #st.success("✅ Bill pdf generated successfully!")
